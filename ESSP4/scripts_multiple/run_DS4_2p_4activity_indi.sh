...
#BSUB -o /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/out_multiple/Output_DS4_2p_4activity_indi.out

# Change to activity directory
cd /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_multiple/DS4/DS4_2p/DS4_2p_4activity_indi

# Clean up previous runs
rm -f configuration_file_emcee_run_DS4_2p_4activity_indi.log
