...
#BSUB -o /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/out_multiple_dynasty/Output_DS6_2p_white_noise.out

# Change to configuration directory
cd /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_multiple_dynasty/DS6/DS6_2p/DS6_2p_white_noise
...
pyorbit_run dynesty DS6_2p_white_noise.yaml > configuration_file_emcee_run_DS6_2p_white_noise.log
pyorbit_results dynesty DS6_2p_white_noise.yaml -all >> configuration_file_emcee_run_DS6_2p_white_noise.log
