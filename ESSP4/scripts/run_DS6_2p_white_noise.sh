...
#BSUB -o ../out/Output_DS6_2p_white_noise.out

# Change to activity directory
cd ../results_jz/DS6/DS6_2p/DS6_2p_white_noise

# Clean up previous runs
rm -f configuration_file_emcee_run_DS6_2p_white_noise.log Output_DS6_2p_white_noise.out
