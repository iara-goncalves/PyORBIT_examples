...
#BSUB -o ../out/Output_DS9_1p_white_noise.out

# Change to activity directory
cd ../results_jz/DS9/DS9_1p/DS9_1p_white_noise

# Clean up previous runs
rm -f configuration_file_emcee_run_DS9_1p_white_noise.log Output_DS9_1p_white_noise.out
